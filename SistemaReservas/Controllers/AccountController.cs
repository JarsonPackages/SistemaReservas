...
namespace SistemaReservas.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public AccountController(IdentityUserManager userManager, IdentitySignInManager signInManager, IdentityRoleManager roleManager)
        {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl, string tipo)
        {
            ...
            //var Role = UserManager.GetRoles(UserManager.Users.Where(X => X.Email == model.Email).First().UserId).First();
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    if(tipo == "A")
                    {
                        return RedirectToAction("Index", "Home", new { area = "Apoio" });
                    }
                    else if(tipo == "R")
                    {
                        return RedirectToAction("Index", "Home", new { area = "Recepcao" });
                    }
                    else 
                    {
